...
@Service("master_bookingList_GET")
@Scope("prototype")
public class master_bookingList_GET extends ApiRequestTemplate {

    @Autowired
    private SqlSession sqlSession;

    public master_bookingList_GET(Map<String, String> reqData) {
        super(reqData);
    }
    ...
    public void service() throws ServiceException {
        ...
        List<Map<String, String>> result = sqlSession.selectList("booking.get_bookingList_forMaster", this.reqData);
        ...
        this.apiResult.add("bookingList",infoArray);
