...
@Service("beautyList_GET")
@Scope("prototype")
public class beautyList_GET extends ApiRequestTemplate {

    @Autowired  
    private SqlSession sqlSession;

    public beautyList_GET(Map<String, String> reqData) {
        super(reqData);
    }
    ...
    public void service() throws ServiceException {
        List<Map<String, Object>> result = sqlSession.selectList("beauty.getBeatyList", this.reqData);
