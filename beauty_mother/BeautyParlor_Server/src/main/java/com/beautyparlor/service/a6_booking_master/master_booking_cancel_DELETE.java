...
@Service("master_booking_cancel_DELETE")
@Scope("prototype")
public class master_booking_cancel_DELETE extends ApiRequestTemplate {

    @Autowired
    private SqlSession sqlSession;

    public master_booking_cancel_DELETE(Map<String, String> reqData) {
        super(reqData);
    }
...
//        }
    ...
    public void service() throws ServiceException {
        ...
        try {
            ...
            FCM_Magager fcmm = new FCM_Magager(map.get("phone_Id"), "예약 취소", msg, SC.isMaster_user);
